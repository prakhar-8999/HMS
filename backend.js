...
app.controller('patient-register',function($scope,$http){
    ...
    $scope.register = function(){
        if ($scope.pass1 != $scope.pass2){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Patient/registration',
                data:data
            })
...
app.controller('patient-login',function($scope,$http,$window,$rootScope,$state){
    ...
    $scope.patientlogin = function() {
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/login',
            data:logininfo
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('Receptionist-login',function($scope,$http,$state){
    ...
    $scope.relogin = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/login',
            data:redata
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('DoctorLo',function($scope,$http,$window,$state){
    ...
    $scope.dologin = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/login',
            data:doinfo
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('DoctorRe',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Doctor/Specialization'
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.dores = function(){
        if ($scope.pass1 != $scope.cpass){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Doctor/registration',
                data:dore
            })
            .then(function (response){
...
app.controller('patient-dashboard',function($scope,$rootScope,$window,$http,$location){
    ...
    if (list === null){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/home',
            data:token
        })
        .then(function (response){
            if (response.status == 200){
                ...
                $http({
                    method:'POST',
                    url:'http://10.21.85.30:8000/Patient/Doctors'
                })
                .then(function (response){
                    if (response.status == 200){
    ...
    document.getElementById('logoutbtn').addEventListener('click',function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/logout',
            data:token
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('appointment',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Patient/Disease',
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.doc = function(){
        if($scope.Speciality != undefined){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Patient/Appointment/Doctors',
                data:spe
            })
            .then(function (response){
                if (response.status == 200){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Receptionist/Doctor/Speciality'
    })
    .then(function(response){
    ...
    $scope.feees = function(){
        if($scope.lidoctor != undefined){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Patient/Appointment/Doctor/Fees',
                data:docid
            })
            .then(function (response){
                if (response.status == 200){
    ...
    $scope.appointment = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/Appointment',
            data:apdata
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('p-appointment',function($rootScope,$http,$scope){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Patient/Appointment/History',
        data:pdata
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.update = function(){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Patient/App/Update',
                data:upadteid
            })
            .then(function (response){
                if (response.status == 200){
    ...
    $scope.makepay = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/Appointment/Payment',
            data:iiddd
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('p-history',function($http,$scope){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Patient/Payment/History',
        data:pay
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.payre = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/Payment/Receipt',
            data:p
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('doctor-dashboard',function($scope,$http,$window,$state,$location){
    ...
    if (list === null){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Appointment/Notification',
            data:token
        })
        .then(function (response){
            if (response.status == 200){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Patients',
            data:token
        })
        .then(function (response){
            if (response.status == 200){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/home',
            data:token
        })
        .then(function (response){
            if (response.status == 200){
    ...
    $scope.dologout = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/logout',
            data:token
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('doc-pa-appointment',function($scope,$http){
    ...
    $scope.reject = function(id){
        if(document.getElementById('reason').value == null){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Doctor/Appointment/Status',
                data:rej
            })
            .then(function (response){
                if (response.status == 200){
...
app.controller('approved-patient',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Doctor/Appointments',
        data:token
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.getdata = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Patient/Detail',
            data:get
        })
        .then(function (response){
            if (response.status == 200){
    ...
    $scope.generate = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Patient/Prescription',
            data:generate
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('doc-book-app',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Doctor/Appointment/patient',
        data:docapbo
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.ge = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Appointment/patient/gender',
            data:forgen
        })
        .then(function (response){
            if (response.status == 200){
    ...
    $scope.docappointment = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Book/Appointment',
            data:docapp
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('p-prescription',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Patient/Prescription/det',
        data:padata
    })
    .then(function (response){
    ...
    $scope.showpres = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Patient/Prescription',
            data:shpres
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('visited-pa',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Doctor/Previous/Appointment',
        data:token
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.showpres = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Doctor/Previous/Patient/Prescription',
            data:shpres
        })
        .then(function (response){
            if (response.status == 200){
...
app.controller('Receptionist-dashboard',function($scope,$http,$state){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Receptionist/home',
        data:reda
    })
    .then(function(response){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Receptionist/Doctor/View',
        data:reda
    })
    .then(function(response){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Receptionist/Patient/View',
        data:reda
    })
    .then(function(response){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Receptionist/Notification',
        data:reda
    })
    .then(function(response){
...
app.controller('re-ap-book',function($scope,$http){
    ...
    $http({
        method:'POST',
        url:'http://10.21.85.30:8000/Receptionist/App/Patient',
        data:rede
    })
    .then(function (response){
        if (response.status == 200){
    ...
    $scope.geen = function(){
        ...
        $http({
            method:'POST',
            url: 'http://10.21.85.30:8000/Receptionist/Patient/Gender',
            data:fgen
        })
        .then(function(response){
    ...
    $scope.reappointment = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Add/Appointment',
            data:reapdata
        })
        .then(function(response){
            Swal.fire({
...
app.controller('re-pending-ap',function($scope,$http){
    ...
    $scope.reject = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Appointment',
            data:fgdat
        })
        .then(function(response){
            Swal.fire({
...
app.controller('doctor-database',function($scope,$http){
    ...
    $scope.viewde = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Doctor/Detail',
            data:vido
        })
        .then(function(response){
    ...
    $scope.viewpat = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Patient/Doc/Detail',
            data:vipa
        })
        .then(function(response){
...
app.controller('Patient-database',function($scope,$http){
    ...
    $scope.paview = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Patient/Detail',
            data:paid
        })
        .then(function(response){
    ...
    $scope.apshow = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Patient/Pre/Appointment',
            data:apd
        })
        .then(function(response){
    ...
    $scope.dele = function(id){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Patient/Delete',
            data:del
        })
        .then(function(response){
            Swal.fire({
...
app.controller('report',function($scope,$http){
    ...
    $scope.bydate = function(){
        ...
        $http({
            method:'POST',
            url:'http://10.21.85.30:8000/Receptionist/Patient/App/Date',
            data:datee
        })
        .then(function (response){
            if (response.status == 200){
    ...
    $scope.bydisease = function(){
        ...
        if($scope.dis == undefined){
            ...
            $http({
                method:'POST',
                url:'http://10.21.85.30:8000/Receptionist/Disease/Patient',
                data:disea
            })
            .then(function (response){
                if (response.status == 200){
